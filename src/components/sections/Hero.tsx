  ...
  return (
    <section className="relative h-[80vh] md:h-[85vh] min-h-[500px] md:min-h-[600px] w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center text-white">
        {!settingsLoading && (
          <>
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-headline font-bold mb-12 tracking-tight animate-in fade-in slide-in-from-bottom-4 duration-1000 uppercase leading-tight drop-shadow-[0_8px_20px_rgba(0,0,0,1)]">
