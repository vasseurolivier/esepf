      ...
      <div className="container mx-auto px-6">
        <ScrollReveal className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-2/3 text-white">
            <h2 className="text-3xl md:text-6xl font-headline font-bold mb-6 text-center lg:text-left leading-tight">{t.sections.student_life_title}</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div className="bg-white/10 p-6 md:p-8 rounded-3xl border border-white/20 backdrop-blur-sm shadow-xl">
                <h4 className="font-bold text-xl mb-2 text-white border-b border-white/10 pb-2">Activités</h4>
                <p className="text-white/70 text-sm">Théâtre, Chorale, Club Échecs, Programmation.</p>
              </div>
              <div className="bg-white/10 p-6 md:p-8 rounded-3xl border border-white/20 backdrop-blur-sm shadow-xl">
                <h4 className="font-bold text-xl mb-2 text-white border-b border-white/10 pb-2">Sports</h4>
                <p className="text-white/70 text-sm">Rugby, Gymnastique, Escalade, Natation.</p>
              </div>
            </div>
          </div>
