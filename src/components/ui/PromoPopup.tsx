...
export function PromoPopup() {
  ...
  useEffect(() => {
    // Show popup after a short delay on home page
      ...
      <div className="relative w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="h-32 bg-primary relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
            <span className="text-secondary font-bold uppercase tracking-[0.3em] text-[10px] mb-1">XIE HUI ACADEMY FRANCE</span>
...
// Internal trophy icon for the popup
