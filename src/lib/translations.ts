...
export const translations = {
  fr: {
    ...
    football_pages: {
      ...
      prog_intro_2: "Nous préparons nos joueurs et athlètes à atteindre leurs objectifs, qu'ils soient de haut niveau ou personnels. À travers des entraînements rigoureux, des compétitions et un suivi personnalisé, chaque élève progresse sur les plans techniques, tactiques et physiques.",
      ...
      french_method_p1: "Nous nous inspirons de l'excellence reconnue de la méthodologie de formation française en football pour proposer un programme de développement structuré et complet, conçu pour accompagner les joueurs dans leur progression globale.",
      french_method_p2: "Ce programme repose sur des séances variées intégrant des exercices techniques, tactiques et physiques adaptés à l'âge, au niveau et aux besoins spécifiques de chaque joueur. Des tests réguliers permettent d'évaluer leur évolution, tandis que des matchs, défis spécifiques et interactions individuelles offrent des opportunités continues d'ajustement et d'amélioration.",
      french_method_p3: "Au-delà du terrain, le programme met un accent particulier sur le développement personnel et émotionnel des participants. À travers des défis psycho-sociaux soigneusement intégrés, les joueurs apprennent des valeurs essentielles telles que l'esprit d'équipe, la discipline, la résilience, la capacité à gérer les émotions et la dévotion. Ces valeurs ne se limitent pas à leur impact sportif mais contribuent également à leur épanouissement en tant qu'individus.",
      french_method_p4: "L'objectif est de former des joueurs complets, capables de briller techniquement et physiquement tout en possédant les qualités humaines nécessaires pour évoluer dans un environnement collectif. En cultivant une passion authentique et durable pour le football, ce programme leur permet non seulement de progresser sur le terrain mais aussi de bâtir une base solide pour leur avenir sportif et personnel."
    },
    metiers_page: {
