...
export const translations = {
  fr: {
    ...
    campus_pages: {
      ...
      bazeilles_desc: "Notre site de Sainte-Bazeille (47) vous accueille dans un cadre calme and verdoyant au cœur du Lot-et-Garonne. Idéal pour vos formations, il dispose de salles modulables entièrement équipées, d'un terrain de sport pour les activités de groupe, and d'un espace de détente chaleureux.\nL'hébergement sur place and la restauration vous garantissent un séjour tout compris and serein.",
      bazeilles_culture: "Culture & Terroir",
      bazeilles_culture_desc: "Sainte-Bazeille est réputée pour sa convivialité and ses infrastructures sportives de premier plan, parfaitement intégrées à la vie locale.",
      bazeilles_infra_desc: "Le Campus de Sainte-Bazeille se distingue par son architecture moderne and ses espaces de co-working.",
