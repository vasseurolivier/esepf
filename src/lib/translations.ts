export const translations = {
  ...
  zh: {
    ...
    formations: {
      ...
      fle_desc: "为非法国母语学生打造的卓越路径，旨在帮助他们掌握莫里哀的语言并平稳融入法国教育体系。",
    ...
    football_pages: {
      ...
      axes_ment: "心理",
      axes_ment_desc: "我们的训练方法不断挑战球员的极限，迫使 them 调动心理资源. 性格力量是影响表现的关键因素之一，我们设计了许多练习让球员锻炼这种特质（1对1、人数劣势比赛、高强度体能训练、肌肉强化、高标准要求等）。鉴于职业足球需要强大的心理素质，球员从小培养这种素质至关重要。",
      axes_social: "社会",
    ...
    support_page: {
      title: "身心支持",
      desc: "专业团队保证最佳条件. 得益于 our 教练、体能训练师和运动健康专家的专业知识，we 提供高质量的监督，同时促进 every 学生的表现和福祉。",
      team_title: "我们的团队",
      kine: "物理治疗师",
      mental: "心理教练",
      medecin: "医生",
