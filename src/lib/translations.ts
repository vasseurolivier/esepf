...
export const translations = {
  fr: {
    ...
    registration: {
      ...
      placeholder_grade: "Ex: 4ème, Seconde...",
      email: "Adresse email de contact",
      phone: "Téléphone",
      campus_choice: "Campus souhaité",
      program_choice: "Niveau / Filière visée",
      campus_placeholder: "Choisir un campus",
      program_placeholder: "Choisir une formation",
      campus_evron_full: "Campus Pays de la Loire (Le Mans)",
      campus_bazeille_full: "Campus Aquitaine (Bordeaux)",
      campus_tulle_full: "Campus Provence (Aix en Provence)",
      program_college: "Collège",
      program_bac_gen: "Bac Général",
      program_bac_stmg: "Bac Techno STMG",
      program_integration: "Classe d'Intégration (FLE)",
    ...
    formations: {
      ...
      integration_maths: "Mathématiques",
      integration_sciences: "Sciences",
      ...
      bac_americain_title: "BACCALAUREAT AMERICAIN",
    ...
    football_pages: {
      ...
      reconnaissance_p2: "La mission des centres de formation de football français est de développer nos jeunes footballeurs en les plaçant dans un environnement compétitif, with un encadrement de haute qualité et un programme éducatif français conçu pour les aider à atteindre leur plein potentiel.",
    ...
    legal: {
      ...
      collect_title: "Collecte des données",
      collect_desc: "Dans le cadre de votre demande d'inscription ou de contact, l'ESEPF collecte des données à caractère personnel vous concernant. Ces données sont traitées uniquement pour la gestion de votre dossier pédagogique et sportif.",
      purpose_title: "Utilisation et Finalités",
      purpose_desc: "Vos données sont utilisées pour :",
      purpose_list: [
        "L'étude de la candidature à l'entrée de l'établissement.",
        "L'organisation des entretiens de motivation.",
        "La communication relative à la scolarité et à l'Academy de football.",
        "La mise en conformité avec les obligations légales éducatives (France & Chine)."
      ],
      share_title: "Partage des données",
      share_desc: "L'ESEPF s'engage à ne jamais vendre ni louer vos données à des tiers. Elles ne sont transmises qu'aux services internes administratifs et pédagogiques de l'ESEPF.",
      rights_title: "Vos Droits (RGPD)",
      rights_desc: "Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez d'un droit d'accès, de rectification et de suppression de vos données.",
      rights_contact: "Pour exercer vos droits, contactez notre délégué à la protection des données :",
      editor_full: "ESEPF - École des Sports et du Prestige Français",
      editor_legal: "Association loi 1901 / Organisme de formation",
      editor_director: "Directeur de la publication : Direction Générale ESEPF",
      hosting_provider: "Google Cloud Platform (Firebase App Hosting)",
      hosting_entity: "Google Ireland Limited",
      hosting_address: "Gordon House, Barrow Street, Dublin 4, Ireland",
      hosting_china_note: "Nos serveurs sont déployés sur des infrastructures mondiales pour garantir une accessibilité optimale.",
      property_desc: "L'ensemble de ce site relève de la législation française et internationale sur le droit d'auteur et la propriété intellectuelle. Tous les droits de reproduction sont réservés, y compris pour les documents téléchargeables et les représentations iconographiques et photographiques.",
      property_logos: "Les logos des clubs partenaires et fédérations cités restent la propriété exclusive de leurs détenteurs respectifs."
    },
    footer: {
  ...
  en: {
    ...
    common: {
      ...
      placeholder_email: "Ex: john@example.com",
      placeholder_code: "ABC-123",
    ...
    registration: {
      ...
      grade: "Current Grade",
      placeholder_grade: "Ex: 8th Grade, 10th Grade...",
      email: "Contact Email",
      phone: "Phone Number",
      ...
      campus_evron_full: "Pays de la Loire Campus (Le Mans)",
      campus_bazeille_full: "Aquitaine Campus (Bordeaux)",
      campus_tulle_full: "Provence Campus (Aix en Provence)",
      program_college: "Middle School",
      program_bac_gen: "General Bac",
      program_bac_stmg: "STMG Techno Bac",
      program_integration: "Integration Class (FLE)",
    ...
    formations: {
      ...
      integration_maths: "Mathematics",
      integration_sciences: "Sciences",
      integration_harmonization_title: "Harmonization of acquired skills",
      integration_harmonization_desc: "A dedicated tutor monitors each student's academic progress to identify gaps and fill them quickly before entering 10th grade.",
    ...
    lycee_page: {
      ...
      bac_stmg: {
        ...
        future_manager: "Your future as a manager",
    ...
    legal: {
      ...
      collect_title: "Data Collection",
      collect_desc: "In the context of your registration or contact request, ESEPF collects personal data concerning you. This data is processed only for the management of your pedagogical and sporting file.",
      purpose_title: "Use and Purposes",
      purpose_desc: "Your data is used for:",
      purpose_list: [
        "Review of the candidacy for entry into the establishment.",
      ...
      share_title: "Data Sharing",
      share_desc: "ESEPF commits to never selling or renting your data to third parties. They are only transmitted to internal administrative and pedagogical services of ESEPF.",
      rights_title: "Your Rights (GDPR)",
      rights_desc: "In accordance with the General Data Protection Regulation (GDPR), you have a right of access, rectification and deletion of your data.",
      rights_contact: "To exercise your rights, contact our data protection officer:",
      editor_full: "ESEPF - School of Sports and French Prestige",
      editor_legal: "Association law 1901 / Training organization",
      editor_director: "Publication Director: ESEPF General Management",
      hosting_provider: "Google Cloud Platform (Firebase App Hosting)",
      hosting_entity: "Google Ireland Limited",
      hosting_address: "Gordon House, Barrow Street, Dublin 4, Ireland",
      hosting_china_note: "Our servers are deployed on global infrastructure to guarantee optimal accessibility.",
      property_desc: "This entire site is subject to French and international legislation on copyright and intellectual property. All reproduction rights are reserved, including for downloadable documents and iconographic and photographic representations.",
      property_logos: "The logos of partner clubs and federations cited remains the exclusive property of their respective holders."
    },
    footer: {
  ...
  zh: {
    ...
    common: {
      ...
      inspirations: "灵感来源：",
      and: "和",
      placeholder_name: "例：张三",
      placeholder_email: "例：zhangsan@example.com",
      placeholder_code: "ABC-123",
      placeholder_message: "您的留言..."
    },
    registration: {
      title: "报名登记表",
      ...
      nationality: "国籍",
      grade: "目前年级",
      placeholder_grade: "例：初二、高一...",
      email: "联系邮箱",
      phone: "联系电话",
      campus_choice: "意向校区",
      program_choice: "意向年级或方向",
      campus_placeholder: "选择一个校区",
      program_placeholder: "选择一个项目",
      campus_evron_full: "卢瓦尔河地区校区 (勒芒)",
      campus_bazeille_full: "阿基坦校区 (波尔多)",
      campus_tulle_full: "普罗旺斯校区 (艾克斯-普罗旺斯)",
      program_college: "初中",
      program_bac_gen: "普通高中",
      program_bac_stmg: "STMG 技术高中",
      program_integration: "整合班 (FLE)",
      code_ref: "推荐码 (选填)",
    ...
    axes: {
      ...
      languages_desc: "我们的机构 offer 强化的法语对外汉语（FLE）和英语对外汉语（EFL）培训，以最好地支持 non-French speaking students 或 者希望完善其水平的学生。\n课程以小组形式组织，以鼓励口语参与、理解 和 个人进步. 教师根据每个学生的需求调整教材，从语法、词汇到具体的交流场景。\n这种强化方法促进了学校融合、考试成功 和 国际化开放。",
      fle_link: "法语对外汉语 (FLE)",
      efl_link: "英语对外汉语 (EFL)"
    },
    academy_features: {
    ...
    formations: {
      ...
      integration_maths: "数学",
      integration_sciences: "科学",
      integration_harmonization_title: "学业水平同步",
      integration_harmonization_desc: "专属导师跟踪每位学生的学业进展，识别薄弱环节并在进入高一前快速弥补。",
    ...
    football_pages: {
      ...
      french_method_p2: "该计划基于多样化的训练课，融合了根据球员年龄、水平和具体需求量身定制的技术、战术及体能练习. 定期s测试将用于评估其进步情况，而比赛、特定挑战和个人互动则提供了持续调整与优化的机会。",
    ...
    legal: {
      ...
      contact_info: "法律联系",
      collect_title: "数据收集",
      collect_desc: "在您的注册或联系请求范围内，ESEPF会收集您的个人数据。这些数据的处理仅用于您的教学和体育档案管理。",
      purpose_title: "使用与目的",
      purpose_desc: "您的数据用于：",
      purpose_list: [
        "审查入学申请。",
      ...
      share_title: "数据共享",
      share_desc: "ESEPF承诺绝不向第三方出售或出租您的数据。它们仅传输给ESEPF内部的行政和教学部门。",
      rights_title: "您的权利 (GDPR)",
      rights_desc: "根据通用数据保护条例（GDPR），您拥有访问、更正和删除您的数据的权利。",
      rights_contact: "如需行使您的权利，请联系我们的数据保护专员：",
      editor_full: "ESEPF - 法国体育与声望学院",
      editor_legal: "1901年法协会 / 培训机构",
      editor_director: "出版总监：ESEPF总管理部",
      hosting_provider: "Google Cloud Platform (Firebase App Hosting)",
      hosting_entity: "Google Ireland Limited",
      hosting_address: "Gordon House, Barrow Street, Dublin 4, Ireland",
      hosting_china_note: "我们的服务器部署在全球边缘节点，以确保极速访问。",
      property_desc: "本网站及其所有内容（文字、图片、视频、标志）均为 ESEPF 的专有财产。未经事先书面许可，严禁任何形式的复制、修改或传播。",
      property_logos: "本站所引用的合作俱乐部标志（法国足球俱乐部、欧足联等）其版权归各自所有者所有。"
    },
    footer: {
      desc: "卓越教育成就学生成功。",
      campus: "我们的校区",
