...
export const translations = {
  fr: {
    ...
    campus_pages: {
      ...
      evron_sub: "Le cœur historique et administratif de l'ESEPE en Mayenne, proche du Mans.",
      evron_region: "Évron Mayenne (53)",
  ...
  en: {
    ...
    college_page: {
      ...
      year1_desc: "The proposed program will allow them to acquire solid mastery of the French language (FLE) while following academic fundamentals.",
  ...
  zh: {
    ...
    college_page: {
      ...
      year1_title: "第一年：整合班",
      year1_desc: "该计划允许学生在学习学术基础知识的同时，掌握扎实的法语 (FLE)。",
      year2_title: "第二年：七年级",
    ...
    campus_pages: {
      evron_hero: "卢瓦尔河地区校区",
      evron_sub: "ESEPE 在马耶讷省的历史和行政核心，靠近勒芒。",
      evron_region: "Évron 马耶讷省",
