...
export const translations = {
  fr: {
    ...
    campus_pages: {
      ...
      bazeilles_strategic: "Un carrefour stratégique en Lot-et-Garonne",
      bazeilles_strategic_desc: "Située aux portes de Marmande, Sainte-Bazeilles bénéficie d'une situation géographique privilégiée. Ville de tradition et de modernité, elle offre un cadre de vie dynamique entre Bordeaux et Toulouse.",
      culture_terroir: "Culture & Terroir",
      ...
      bazeilles_modern_infra: "Le Campus de Sainte-Bazeilles se distingue par son architecture moderne et ses espaces de co-working.",
      tulle_charm: "Le charme et le soleil des Alpes-de-Haute-Provence",
      tulle_charm_desc: "Aux portes du Luberon, Sainte-Tulle est une cité au patrimoine riche, baignée par le soleil de la Provence. Ville à taille humaine, elle offre un cadre naturel exceptionnel propice au ressourcement.",
      tulle_sporty_city: "Une Ville Sportive",
      tulle_sporty_desc: "Sainte-Tulle bénéficie d'un climat exceptionnel toute l'année, idéal pour la pratique sportive intensive en plein air.",
      tulle_approach: "Le Campus de Sainte-Tulle privilégie une approche humaine et individualisée de l'enseignement.",
  ...
  en: {
    ...
    campus_pages: {
      ...
      bazeilles_strategic: "A strategic crossroads in Lot-et-Garonne",
      bazeilles_strategic_desc: "Located at the gates of Marmande, Sainte-Bazeilles benefits from a privileged geographical situation. A city of tradition and modernity, it offers a dynamic living environment between Bordeaux and Toulouse.",
      culture_terroir: "Culture & Terroir",
      ...
      bazeilles_modern_infra: "The Sainte-Bazeilles Campus is distinguished by its modern architecture and co-working spaces.",
      tulle_charm: "The charm and sun of the Alpes-de-Haute-Provence",
      tulle_charm_desc: "At the gates of the Luberon, Sainte-Tulle is a city with a rich heritage, bathed in the Provence sun. A human-sized city, it offers an exceptional natural setting conducive to rejuvenation.",
      tulle_sporty_city: "A Sporty City",
      tulle_sporty_desc: "Sainte-Tulle benefits from an exceptional climate all year round, ideal for intensive outdoor sports practice.",
      tulle_approach: "The Sainte-Tulle Campus favors a human and individualized approach to teaching.",
  ...
  zh: {
    ...
    common: {
      ...
      enrollment_stmg: "STMG与奢侈品方向（2026年入学）申请已开启。今天就开始开发您的管理潜力。",
    ...
    team_page: {
      ...
      team_title: "团队介绍",
      staff_title: "我们的教职员工",
      staff_desc: "由高级教师和欧足联认证教练组成的团队，提供卓越的指导。",
      success_rate: "100% 考试成功率",
      uefa_cert: "员工认证",
      discipline_title: "纪律",
      discipline_desc: "球场和课堂上追求卓越的关键。",
      solidarity_title: "团结",
      solidarity_desc: "超越国界的团队精神。",
      ambition_title: "雄心",
      ambition_desc: "瞄准全球学术和体育巅峰。",
      innovation_title: "创新",
    ...
    college_page: {
      ...
      year2_desc: "深化学术和体育技能的关键一年，同时充分融入机构生活。",
    ...
    lycee_page: {
      ...
      bac_vente: {
        ...
        profile_title: "招生对象",
        profile_desc: "面向以下学生：",
        profile_list: ["初中毕业生进入专业高一", "高一或高二学生进入专业高二"],
        qualities_title: "所需素质",
