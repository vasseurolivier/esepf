  ...
  fr: {
    ...
    lycee_page: {
      ...
      bac_gen: {
        ...
        desc: "Le Baccalauréat Général est une formation en trois ans qui préape les lycéens à la poursuite d'études supérieures dans divers domaines. Il repose sur un tronc commun qui assure une culture générale solide et sur le choix de spécialités permettant d'approfondir certaines disciplines selon les aspirations et les projets de chaque élève.",
