...
export const translations = {
  fr: {
    ...
    campus_locations: {
      evron: "Evron (LE MANS)",
      bazeille: "Sainte-Bazeille (BORDEAUX)",
    ...
    college_page: {
      ...
      year2_desc: "Une année charnière pour approfondir les compétences académiques et sportives tout en s'intégrer pleinement à la vie de l'Institution.",
      ...
      fulfillment_desc: "Concilier passion sportive and amitiés durables dans un cadre sécurisant."
    },
    lycee_page: {
      title: "BACCALAUREATS",
      intro_p1: "Notre lycée propose un parcours exigeant et diversifié, adapté aux aspirations and projets de chaque élève. Il offre trois filières principales : le baccalauréat général, le baccalauréat technologique STMG (Sciences and Technologies du Management and de la Gestion) and le baccalauréat professionnel Vente.",
      intro_p2: "Chaque programme est conçu pour permettre aux élèves d’acquérir des compétences solides and de préparer leur orientation vers l’enseignement supérieur ou le monde professionnel.",
      intro_p3: "Le bac général développe l’esprit d’analyse and la culture générale, le bac STMG prépare à des études en gestion, commerce and économie, tandis que le bac pro Vente offre une formation pratique and opérationnelle pour intégrer rapidement le secteur du commerce.",
      intro_p4: "Un accompagnement personnalisé and un suivi régulier sont assurés pour garantir la réussite de chaque élève dans sa voie choisie.",
      ...
      bac_gen: {
        ...
        desc: "Le Baccalauréat Général est une formation en trois ans qui prépare les lycéens à la poursuite d'études supérieures dans divers domaines. Il repose sur un tronc commun qui assure une culture générale solide and sur le choix de spécialités permettant d'approfondir certaines disciplines selon les aspirations and les projets de chaque élève.",
        system_desc: "Dans le cadre du baccalauréat général en France, tous les élèves suivent d'abord une classe de Seconde générale and technologique, qui constitue un tronc commun sans spécialisation. À partir de la Première, ils doivent choisir trois spécialités parmi celles proposées, en plus des enseignements communs. Enfin, en Terminale, ils conservent deux de ces spécialités, qu'ils approfondissent jusqu'à l'examen du baccalauréat.",
        ...
        specialties: [
          ...
          { name: "Éducation Physique, Pratiques et Culture Sportive (EPPCS)", desc: "idéale pour les élèves passionnés de sport, souhaitant allier théorie and pratique dans une perspective de performance and de compréhension du monde sportif." },
          { name: "Mathématiques", desc: "une spécialité essentielle pour acquérir des compétences analytiques and logiques, ouvrant la voie aux études scientifiques and économiques." },
          { name: "Numérique et Sciences Informatiques (NSI)", desc: "destinée aux élèves intéressés par l'informatique, la programmation and les enjeux du numérique dans notre société." }
        ],
        conclusion: "Cette formation complète permet aux élèves d'acquérir des compétences variées and adaptées aux exigences du monde d'aujourd'hui, tout en leur offrant une grande liberté dans le choix de leur parcours post-bac.",
        ...
        qualities_list: [
          "Passion pour les langues and la culture étrangère.",
          "Aisance rédactionnelle and orale.",
          "Curiosité and ouverture d'esprit pour les cultures internationales.",
          "Volonté de perfectionner ses compétences linguistiques and d'explorer des horizons variés.",
          "Capacité à travailler de manière autonome and à effectuer des recherches approfondies."
        ],
        campuses: "Tous les campus",
        duration: "3 ans (4 ans pour les allophones)",
        level: "Niveau 4 (Baccalauréat)",
        bts_desc: "Le BTS (Brevet de Technicien Supérieur) en Langues Étrangères Appliquées (LEA) est une formation de deux ans qui permet de se spécialiser après un Baccalauréat Général.\nElle offre un enseignement pratique and théorique dans des domaines tels que la traduction, l'interprétation, la gestion de projets internationaux, ainsi que la communication interculturelle.\nAccessible sur dossier, le BTS prépare rapidement à des postes à responsabilités dans des secteurs en pleine expansion, comme le commerce international, le tourisme, la gestion de la relation client, ou encore les métiers de la traduction and de l'interprétariat.",
        univ_desc: "L'accès à une licence après un Baccalauréat Général permet de se spécialiser dans des domaines comme la traduction, l'interprétation, les relations internationales, ou encore la communication interculturelle.\nLa licence est une formation universitaire de niveau Bac+3 d'une durée de 3 ans, qui combine des enseignements théoriques and pratiques. Elle permet de consolider les compétences linguistiques and culturelles acquises au lycée and prépare à une entrée réussie dans le monde professionnel.\nAprès un BTS en langues étrangères appliquées ou dans des domaines connexes, il est également possible de rejoindre directement la dernière année de licence pour approfondir ses compétences and élargir ses perspectives professionnelles.",
      ...
      bac_vente: {
        ...
        desc: "Le Bac Pro Métiers du Commerce and de la Vente, spécialisé dans l'univers du luxe, prépare les étudiants à intégrer un secteur en forte demande, alliant expertise commerciale and connaissance des exigences particulières du marché du luxe. Ce cursus propose une formation complète en techniques de vente, gestion de la relation client and stratégie commerciale, tout en mettant un accent particulier sur les codes du luxe, la gestion des produits haut de gamme and le service client d'excellence.",
        desc_extended: "Les étudiants acquièrent des compétences essentielles pour évoluer dans des boutiques prestigieuses, des maisons de haute couture ou des entreprises de produits de luxe. Grâce à des cours théoriques and pratiques, ce Bac Pro permet aux jeunes d'être immédiatement opérationnels, avec un savoir-faire adapté à un environnement professionnel exigeant and prestigieux.",
        objectives_title: "Objectifs du Bac pro MCV option A et B",
        objectives_desc: "Le titulaire du Bac Pro Métiers du Commerce and de la Vente (MCV), option A ou B, joue un rôle clé au sein de l'équipe commerciale :",
        objectives_list: [
          "Option A : Participer à l'approvisionnement, conseiller, vendre, fidéliser, and animer la surface de vente.",
          "Option B : Gérer la prospection clientèle, valoriser l'offre commerciale and assurer la gestion commerciale liée à sa fonction."
        ],
        objectives_footer: "Cette formation offerte par l'ESEPF permet à ses élèves d'acquérir toutes les compétences nécessaires de l'option qu'ils auront choisie afin de les préparer aux missions variées and adaptées aux besoins du secteur du Commerce and de la Vente.",
        profile_title: "Profil",
        profile_desc: "Le Bac Pro Métiers du Commerce and de la Vente est accessible aux élèves issus de :",
        profile_list: [
        ...
        qualities_list: [
          ...
          "Sens du contact and de l'organisation",
        ...
        direct_employment_text: "Le Bac Pro Métiers du Commerce and de la Vente (MCV) offre aux diplômés une entrée immédiate sur le marché du travail grâce à des compétences pratiques and recherchées par les entreprises.\nEn se spécialisant dans la gestion de la relation client, la vente and l'animation commerciale, les titulaires de ce diplôme peuvent occuper des postes variés dans des secteurs dynamiques, allant de la grande distribution au commerce de luxe.",
        ...
        higher_ed_intro: "Après un Bac Pro Métiers du Commerce and de la Vente (MCV), vous pouvez poursuivre vos études en BTS (Négociation, Management Commercial, Commerce International, etc.) ou en licence universitaire pour approfondir vos compétences and obtenir des postes à responsabilités. Ces formations supérieures vous ouvrent la voie à de nombreuses opportunités dans des secteurs en pleine croissance.",
        bts_desc: "Le BTS (Brevet de Technicien Supérieur) est une formation de deux ans qui permet de se spécialiser après un Bac Professionnel. Elle offre un enseignement pratique and théorique dans des domaines comme la négociation, le management commercial ou le commerce international. Accessible sur dossier, le BTS prépare rapidement à des postes à responsabilités.",
        univ_desc: "L'accès à une licence après un Bac Pro permet de se spécialiser dans des domaines comme le marketing, le commerce ou la gestion. La licence est une formation universitaire de niveau Bac+3 d'une durée de 3 ans, qui combine des enseignements théoriques and pratiques. Elle permet de renforcer les compétences acquises and elle promet une entrée rapide dans le monde professionnel. Après un BTS, il est possible de rejoindre directement la dernière année de licence pour continuer à se perfectionner.",
      ...
      bac_stmg: {
        ...
        desc: "Le Baccalauréat Technologique STMG (Sciences and Technologies du Management and de la Gestion) est une filière qui prépare les élèves aux métiers de la gestion, du management and de l’économie. Ce diplôme allie enseignements généraux and technologiques pour développer des compétences en communication, analyse, organisation and prise de décision dans des contextes professionnels variés. Les élèves y découvrent les fondamentaux du droit, de l’économie, des sciences de gestion, ainsi que des outils numériques essentiels.",
        outro: "Il ouvre la voie à des études supérieures telles que les BTS, BUT, licences ou écoles de commerce, and mène à des carrières dans les domaines de la gestion, du marketing, des ressources humaines ou de la finance.",
        luxe_module_title: "Un Module Luxe en Hôtellerie et Restauration pour nos STMG",
        luxe_module_p1: "Dans un monde où l’hôtellerie and la restauration de luxe sont des secteurs en pleine expansion, il est essentiel de préparer nos élèves aux exigences de cette industrie prestigieuse. C’est pourquoi notre Baccalauréat Technologique STMG inclura un module exclusif dédié à l’hôtellerie and à la restauration haut de gamme.",
        luxe_module_p2: "Ce programme vise à offrir aux élèves un première immersion dans cet univers raffiné, en leur permettant de découvrir les standards de qualité, le service d’excellence and les codes du luxe appliqués à l'accueil, à la gestion and à la relation client. À travers des études de cas concrets, des rencontres avec des professionnels du secteur and des mises en situation, nos élèves développeront des compétences essentielles en management, marketing and gestion hôtelière, tout en cultivant un savoir-être adapté aux attentes de cette industrie exigeante.",
        luxe_module_p3: "Ce module représente une véritable opportunité pour nos élèves, leur ouvrant les portes de formations spécialisées and de carrières internationales dans le domaine du luxe. Il s’inscrit pleinement dans notre commitment à proposer une éducation innovante and professionnalisante, en phase avec les réalités du marché du travail and les aspirations de nos étudiants.",
        campuses: "Tous les campus",
        duration: "3 ans (4 ans pour les allophones)",
        level: "Niveau 4 (Baccalauréat Technologique)",
        bts_desc: "Le BTS (Brevet de Technicien Supérieur) en management ou gestion est une formation de deux ans qui permet de se spécialiser après un Baccalauréat Technologique STMG. Elle offre un enseignement pratique and théorique dans des domaines telles que le management d'équipe, la gestion d'entreprise, la communication, la finance, la comptabilité and le marketing. Accessible sur dossier, le BTS prépare rapidement à des postes à responsabilités dans des secteurs variés comme le commerce, le marketing, la gestion des ressources humaines, ou la gestion d'entreprise, tout en permettant d'évoluer dans un environnement dynamique.",
        univ_desc: "L'accès à une licence après un Baccalauréat Technologique STMG permet de se spécialiser dans des domaines comme le management, la gestion des entreprises, les ressources humaines, le marketing ou la finance. La licence est une formation universitaire de niveau Bac+3 d'une durée de 3 ans, qui combine des enseignements théoriques and pratiques. Elle renforce les compétences en gestion and en analyse acquises au lycée and prépare à une entrée réussie dans le monde professionnel. Après un BTS ou un DUT dans le domaine du management ou de la gestion, il est également possible de rejoindre directement la dernière année de licence pour se perfectionner and accéder à des postes à responsabilités.",
    ...
    football_pages: {
      ...
      prog_intro_1: "Notre école est un centre de formation de football qui offre à ses athlètes un programme complet and structuré, inspiré des meilleures méthodes de formation françaises.",
      prog_intro_2: "Nous préparons nos joueurs and athlètes à atteindre leurs objectifs, qu'ils soient de haut niveau ou personnels. À travers des entrainements rigoureux, des compétitions and un suivi personnalisé, chaque élève progresse sur les plans techniques, tactiques and physiques.",
      prog_intro_3: "Nous mettons également un accent particulier sur le développement mental and humain des athlètes, en les formant à gérer les défis psychologiques du sport de haut niveau. L'esprit d'équipe, la discipline, la résilience and la gestion des émotions sont au cœur de notre approche. Chaque athlète bénéficie d'un encadrement qui lui permet de s'épanouir and de donner le meilleur de lui-même.",
      prog_intro_4: "Notre école donne à ses athlètes la chance d'atteindre leurs objectifs, de s'épanouir and, pour les meilleurs d'entre eux, d'aspirer à devenir sportifs professionnels ou d'obtenir des bourses d'études grâce à leurs performances sportives.",
      france_title: "FRANCE : TERRE DE FOOTBALL",
      france_desc_full: "Au total, la France est le country qui a fourni le plus grand nombre de joueurs pour la Coupe du Monde au 21e siècle, avec 216 participants nés sur son sol, loin devant le Brésil and ses 148 joueurs, pourtant souvent perçu comme le plus grand exportateur de talents. France devance également largement l'Allemagne and l'Italie, tous deux champions du monde à quatre reprises.",
      ...
      reconnaissance_p1: "La France and ses environs ne manquent certainement pas de talents, and cela n'est en rien dû au hasard, but bien à la manière dont les jeunes joueurs sont détectés and formés dans le pays. Cette méthode, dont l'efficacité est reconnue dans le monde entier, est au cœur du succès du football français.",
      reconnaissance_p2: "La mission des Centres de formation de football Français est de développer nos jeunes joueurs de football en les plaçant dans un environnement compétitif, with un encadrement de haute qualité and un programme d'enseignement français conçu pour les aider à atteindre leur plein potentiel.",
      reconnaissance_p3: "Grâce à un programme and une méthodologie structurés, and à travers des séances variées, des tests, des activités, des matchs, des défis and des interactions individuelles, nos joueurs évolueront sur le plan émotionnel, construiront leur caractère and développeront leurs compétences techniques, tactiques and physiques (données ajustées en fonction de l'âge spécifique de chaque joueur).",
      reconnaissance_p4: "Ils progresseront également dans leurs compétences humaines grâce à nos défis psycho-sociaux, en apprenant l'esprit d'équipe, la dévotion, la résilience and, surtout, en nourrissant un amour durable pour le jeu.",
      method_title: "NOTRE MÉTHODOLOGIE",
      method_subtitle: "LES 4 PILIERS DU SUCCÈS",
      axes_tech: "Technique : Travail spécifique sur la maîtrise individuelle du ballon and la coordination.",
      axes_tact: "Tactique : Appréhension des systèmes de jeu, placement and intelligence collective.",
      axes_phys: "Physique : Développement athlétique sécurisé, endurance and explosivité adaptée.",
      axes_ment: "Mental : Accompagnement psychologique, gestion de la pression and esprit de gagne.",
      coaches_title: "NOS COACHS CERTIFIÉS",
      coaches_text: "Nos coachs sont tous diplômés de la FFF ou de l'UEFA (Pro, A, B, C), garantissant une expertise pédagogique and sportive de haut niveau pour un encadrement professionnel quotidien.",
      ...
      weekly_details: "Le programme inclut l'analyse vidéo le lundi, le travail spécifique le mercredi and la préparation de match le vendredi, tout en maintenant un cursus scolaire complet.",
      ...
      weekend: "Week-end",
      weekend_desc: "Matchs de championnat officiel FFF. Déplacements en équipe and compétition de haut niveau."
    },
    metiers_page: {
      title: "UNE FORMATION AUX MÉTIERS DU SPORT",
      optional: "(OPTIONNEL)",
      desc: "ESPF propose plusieurs formations spécialisées dans les métiers du sport, offrant ainsi à nos élèves la possibilité de se préparer à divers parcours professionnels dans ce secteur. Ces formations leur permettent d'acquérir des compétences pratiques and théoriques, adaptées aux exigences de différents domaines du sport. Elles ouvrent ainsi la voie à des carrières diversifiées, en offrant aux étudiants une large gamme d'opportunités dans des secteurs en pleine expansion.",
    ...
    sport_etudes_page: {
      ...
      text1: "Un sport-études est un programme éducatif qui permet aux jeunes de concilier leur parcours scolaire avec une pratique sportive intensive. Conçu pour répondre aux besoins des athlètes en formation, il offre un emploi du temps aménagé qui allie cours académiques and entraînements réguliers. Ce dispositif vise à accompagner les élèves dans leur double projet, en favorisant leur réussite scolaire tout en leur permettant de progresser and d'exceller dans leur discipline sportive.",
      title2: "QUELS SONT LES SPORTS DISPONIBLES ?",
      label2_1: "Football",
      label2_2: "Basketball",
      label2_2_sub: "(Bientôt disponible)",
      text2: "Notre établissement propose un programme sport-études axé sur le football, offrant des entraînements intensifs, des séances techniques, des matchs, and un accompagnement individualisé pour développer les compétences sportives and humaines des élèves. Prochainement, nous élargirons notre offer avec un programme dédié au basketball, permettant aux passionnés de ce sport de bénéficier de la même qualité de formation and d'encadrement.",
      day_title: "UNE JOURNÉE TYPE À L'ESEPF",
      day_desc: "Le rythme d'un athlète est exigeant and demande une organisation rigoureuse entre les cours and les terrains.",
    ...
    journey_page: {
      ...
      interview_desc: "Chaque parcours est unique. Nos tuteurs académiques and nos directeurs sportifs vous accompagnent individuellement pour définir la trajectoire la plus adaptée à vos ambitions.",
    ...
    campus_pages: {
      ...
      bazeille_hero: "Campus Sainte-Bazeille",
      bazeille_sub: "L'innovation pédagogique au cœur du Sud-Ouest.",
      bazeille_title: "Un carrefour stratégique en Lot-et-Garonne",
      bazeille_desc: "Notre site de Sainte-Bazeille (47) vous accueille dans un cadre calme and verdoyant au cœur du Lot-et-Garonne. Idéal pour vos formations, il dispose de salles modulables entièrement équipées, d'un terrain de sport pour les activités de groupe, and d'un espace de détente chaleureux.\nL'hébergement sur place and la restauration vous garantissent un séjour tout compris and serein.",
      bazeille_culture: "Culture & Terroir",
      bazeille_culture_desc: "Sainte-Bazeille est réputée pour sa convivialité and ses infrastructures sportives de premier plan, parfaitement intégrées à la vie locale.",
      bazeille_infra_desc: "Le Campus de Sainte-Bazeille se distingue par son architecture moderne and ses espaces de co-working.",
      tulle_hero: "Campus Sainte-Tulle",
      tulle_sub: "L'excellence au cœur de la Provence.",
      tulle_title: "Le charme and le soleil des Alpes-de-Haute-Provence",
      tulle_desc: "Notre site de Sainte-Tulle (04) vous ouvre ses portes au cœur de la Provence pour vos séminaires and formations.\nNous mettons à votre disposition des salles de formation climatisées and lumineuses, un terrain de sport polyvalent, ainsi qu'un espace de détente propice à la convivialité.\nL'hébergement and la restauration sont assurés sur place pour une immersion totale and sans contrainte.",
      ...
      tulle_infra_desc: "Le Campus de Sainte-Tulle privilégie une approche humaine and individualisée de l'enseignement.",
      infra_title: "Infrastructures d'Excellence",
      city_title: "Cadre de Vie",
      apply_now: "Inscriptions ouvertes pour la rentrée 2026-2027",
      modern_infra_desc: "Des installations modernes conçues pour l'épanouissement académique and sportif.",
    ...
    contact_page: {
      ...
      campus_bazeille: "Sainte-Bazeille (BORDEAUX)",
      ...
      faq_a2: "Niveau technique and dossier scolaire.",
  ...
  en: {
    ...
    campus_pages: {
      ...
      evron_region: "Sarthe (72)",
      evron_region_desc: "Pays de la Loire, France.",
      bazeille_hero: "Sainte-Bazeille Campus",
      bazeille_sub: "Educational innovation in the South-West.",
      bazeille_title: "A strategic crossroads in Lot-et-Garonne",
      bazeille_desc: "Our Sainte-Bazeille site (47) welcomes you to a calm and green setting in the heart of Lot-et-Garonne. Ideal for your training, it has fully equipped modular rooms, a sports field for group activities, and a warm relaxation area.\nOn-site accommodation and catering guarantee an all-inclusive and serene stay.",
      bazeille_culture: "Culture & Terroir",
      bazeille_culture_desc: "Sainte-Bazeille is known for its conviviality and top-notch sports infrastructures, perfectly integrated into local life.",
      bazeille_infra_desc: "The Sainte-Bazeille Campus is distinguished by its modern architecture and co-working spaces.",
  ...
  zh: {
    ...
    formations: {
      ...
      passport_world_desc: "在全球化的世界中，掌握多种语言是必要的。在 ESEPF，我们从初中开始提供强化的语言路径。",
    ...
    lycee_page: {
      ...
      bac_vente: {
        ...
        desc: "销售 和 商业专业高中，专注于奢侈品领域，将商业专业知识 与 奢侈品市场的要求相结合. 该课程提供销售 technique、客户关系管理 和 商业战略方面的全面培训。",
    ...
    campus_pages: {
      ...
      bazeille_hero: "圣巴泽耶校区",
      bazeille_sub: "教学创新中心。",
      bazeille_title: "洛特-加龙省的战略十字路口",
      bazeille_desc: "我们的圣巴泽耶（47）校区欢迎您来到位于洛特-加龙省中心的宁静绿意环境。这里是您进行培训的理想场所，拥有设备齐全的可调节教室、供团体活动使用的运动场 以及 温馨的休闲空间。\n酒店式的校内住宿 和 餐饮为您提供全方位且安心的全包式体验。",
      bazeille_culture: "文化 与 风土",
      bazeille_culture_desc: "圣巴泽耶以其热情友好 和 一流的体育设施而闻名，这些设施与当地生活完美融合。",
      bazeille_infra_desc: "圣巴泽耶校区以其现代建筑 和 联合办公空间而闻名。",
      tulle_hero: "圣蒂勒校区",
      tulle_sub: "普罗旺斯的卓越。",
