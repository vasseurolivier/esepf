  ...
  zh: {
    ...
    lycee_page: {
      ...
      bac_vente: {
        ...
        direct_employment_text: "商业和销售专业高中毕业证书 (MCV) 凭借企业所需的实践技能，为毕业生提供了立即进入劳动力市场的机会。通过专门从事客户关系管理、销售和商业活动，该文凭持有者可以在从大型零售到奢侈品贸易的动态领域担任各种职位。",
        ...
        univ_jobs: ["产品经理", "客户关系经理", "商业项目经理", "传播经理", "商业经理", "企业管理顾问", "数字战略经理"]
      },
      bac_stmg: {
        title: "管理技术高中",
        subtitle: "管理与商务方向",
    ...
    sport_etudes_page: {
      ...
      label1_1: "日常体育练习",
      label1_2: "调整后的学业",
      text1: "体育学习是一项教育计划，允许年轻人将学业与密集的体育练习结合起来。专为满足培训中运动员的需求 at designed, it provide a adapted schedule that combines academic courses and regular training.",
      title2: "有哪些运动项目？",
      label2_1: "足球",
      label2_2: "篮球",
      label2_2_sub: "(即将推出)",
