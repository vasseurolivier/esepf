  ...
  fr: {
    ...
    lycee_page: {
      ...
      bac_gen: {
        ...
        campuses: "Evron, Sainte-Bazeilles & Sainte-Tulle",
        ...
        program_details: "Le cursus se compose d'un tronc commun solide complété par des spécialités exigeantes comme les Mathématiques, les SES ou les Langues. Nous mettons un accent particulier sur la rhétorique et l'argumentation en vue du Grand Oral du Baccalauréat. L'ouverture internationale est renforcée par notre programme de Dual Diploma optionnel, permettant d'obtenir simultanément le High School Diploma américain.",
        bts_desc: "Le BTS (Brevet de Technicien Supérieur) est une formation de deux ans très prisée pour sa spécialisation technique rapide après un Baccalauréat Général.",
        univ_desc: "L'université offre des parcours académiques complets en Licences puis Masters, idéaux pour les profils analytiques issus de la filière générale.",
        bts_list: ["BTS Tourisme", "BTS Commerce International", "BTS Communication", "BTS Support à l'Action Managériale", "BTS Traduction"],
        bts_jobs: ["Chargé(e) de communication", "Assistant(e) export", "Conseiller en voyages", "Gestionnaire de projets culturels", "Attaché de presse"],
        univ_list: ["Licence Langues Étrangères Appliquées (LEA)", "Licence Lettres & Civilisations", "Licence Sciences Po / Droit", "Licence Information-Communication", "Licence Histoire-Géographie"],
        univ_jobs: ["Cadre dans les relations internationales", "Traducteur spécialisé", "Responsable éditorial", "Chargé de mission diplomatique", "Journaliste"]
      },
      bac_vente: {
        title: "BAC PRO VENTE",
        ...
        prog_desc: "Le programme alterne entre théorie en classe et pratique intensive. Les modules clés incluent la prospection clientèle, la conduite d'entretien de vente, la fidélisation et la gestion de l'offre commerciale numérique.",
        program_details: "La formation inclut 22 semaines de Périodes de Formation en Milieu Professionnel (PFMP) réparties sur les 3 ans. Les élèves développent une autonomie réelle et une maîtrise des techniques de persuasion, de la gestion de stock et de l'animation de point de vente. L'usage des outils CRM et des plateformes e-commerce est au cœur de l'apprentissage.",
        bts_desc: "Le BTS MCO (Management Commercial Opérationnel) ou NDRC (Négociation et Digitalisation) sont les suites logiques pour les bacheliers pro.",
        univ_desc: "Les bacheliers pro performants peuvent intégrer des Bachelors en Écoles de Commerce ou des Licences professionnelles spécialisées.",
        bts_list: ["BTS Management Commercial Opérationnel (MCO)", "BTS Négociation et Digitalisation (NDRC)", "BTS Commerce International", "BTS Technico-Commercial"],
        bts_jobs: ["Vendeur(se) expert", "Animateur(trice) de rayon", "Commercial(e) itinérant", "Chargé(e) de clientèle", "Assistant(e) manager de magasin"],
        univ_list: ["Bachelor Business & Marketing", "Licence Pro E-Commerce", "Licence Pro Management du point de vente", "Bachelor International Business"],
        univ_jobs: ["Chef(fe) de secteur vente", "Key Account Manager junior", "Responsable drive", "Business Developer", "Directeur(trice) de magasin adjoint"]
      },
      bac_stmg: {
        title: "BAC TECHNO STMG",
        subtitle: "Métiers du management et de la gestion",
        desc: "Une filière équilibrée pour comprendre le fonctionnement interne des organisations (entreprises, associations, administrations). Elle allie approche théorique et cas pratiques réels avec des outils numériques.",
        campuses: "Evron, Sainte-Bazeilles & Sainte-Tulle",
        duration: "3 ans (4 ans pour les allophones)",
        level: "Niveau 4 (Baccalauréat Technologique)",
        prog_title: "Le Cursus Management",
        prog_desc: "Le programme explore quatre domaines fondamentaux : les sciences de gestion, le management, le droit et l'économie. Les élèves apprennent à analyser la performance d'une organisation.",
        program_details: "La filière STMG s'appuie sur l'étude des organisations réelles. En terminale, l'élève choisit une spécialité parmi : Gestion & Finance, Mercatique (Marketing), Ressources Humaines & Communication, ou Systèmes d'Information de Gestion. Ce parcours prépare aux décisions managériales, à l'analyse financière et à la compréhension des enjeux socio-économiques contemporains.",
        ...
        univ_desc: "Les BUT (Bachelor Universitaire de Technologie) et les Licences de Gestion (MSG) sont des parcours d'excellence pour les STMG.",
        bts_list: ["BTS Gestion de la PME", "BTS Comptabilité et Gestion (CG)", "BTS Support à l'Action Managériale", "BTS Services Informatiques (SIO)"],
        bts_jobs: ["Assistant(e) de gestion", "Comptable junior", "Chargé(e) de recrutement", "Assistant(e) RH", "Technicien(ne) informatique de gestion"],
        univ_list: ["BUT Gestion des Entreprises (GEA)", "BUT Techniques de Commercialisation", "Licence Économie-Gestion", "Bachelor Management & RH"],
  ...
  en: {
    ...
    lycee_page: {
      ...
      bac_gen: {
        ...
        prog_desc: "Core curriculum plus specialty subjects. Strong focus on international paths.",
        program_details: "Complete academic path focusing on humanities, languages, and geopolitics. Includes preparation for the 'Grand Oral'.",
        bts_desc: "The BTS is a two-year professional program allowing for quick technical specialization.",
        univ_desc: "French universities provide academic depth through Bachelor and Master degrees.",
        bts_list: ["BTS Tourism", "BTS International Trade", "BTS Communication", "BTS Management Support"],
        bts_jobs: ["Communication Officer", "Export Assistant", "Travel Consultant", "Project Manager"],
        univ_list: ["Bachelor in Foreign Languages (LEA)", "Bachelor in Law / Political Science", "Bachelor in Journalism", "Master in International Relations"],
        univ_jobs: ["Diplomatic Attaché", "Specialized Translator", "Editorial Manager", "International Relations Officer"]
      },
      bac_vente: {
        title: "PRO SALES BAC",
        subtitle: "Sales and Retail Careers",
        desc: "Practical training to become a customer relationship expert.",
        campuses: "Evron, Sainte-Bazeilles & Sainte-Tulle",
        duration: "3 years (4 for allophones)",
        level: "Level 4 (Professional Diploma)",
        prog_title: "Professional Approach",
        prog_desc: "Intensive training in negotiation and digital sales.",
        program_details: "22 weeks of professional internships included. Focuses on CRM tools, e-commerce, and shop animation.",
        bts_desc: "The BTS MCO or NDRC are the logical next steps for commercial managers.",
        univ_desc: "Vocational graduates can enter specialized Professional Bachelors or Business Schools.",
        bts_list: ["BTS Commercial Management (MCO)", "BTS Digital Relation (NDRC)", "BTS International Trade"],
        bts_jobs: ["Expert Salesperson", "Department Manager", "Field Sales Agent", "Account Executive"],
        univ_list: ["Bachelor in Business & Marketing", "Professional Bachelor in E-Commerce", "International Business Degree"],
        univ_jobs: ["Sales Sector Manager", "Key Account Manager junior", "Drive Manager", "Store Director Assistant"]
      },
      bac_stmg: {
        title: "TECHNO STMG BAC",
        subtitle: "Management and Business Careers",
        desc: "Understand how organizations work through theory and practice.",
        campuses: "Evron, Sainte-Bazeilles & Sainte-Tulle",
        duration: "3 years (4 for allophones)",
        level: "Level 4 (Technological Baccalaureate)",
        prog_title: "Management Track",
        prog_desc: "Exploration of business strategy and digital tools.",
        program_details: "Specializations in Marketing, Finance, or HR. Prepares for managerial decisions and financial analysis.",
        bts_desc: "Technical BTS programs offer immediate specialization in accounting or management.",
        univ_desc: "BUT (Bachelor of Technology) and Management Degrees are excellence paths for STMG profiles.",
        bts_list: ["BTS SME Management", "BTS Accounting & Management", "BTS IT Services"],
        bts_jobs: ["Management Assistant", "Junior Accountant", "HR Assistant", "IT Technician"],
        univ_list: ["BUT Business Management (GEA)", "Bachelor in Management Sciences", "Bachelor in HR Management"],
        univ_jobs: ["Management Controller junior", "HR Project Manager", "Financial Analyst", "Team Manager"]
      }
    },
    football_pages: {
  ...
  zh: {
    ...
    lycee_page: {
      ...
      bac_gen: {
        title: "普通高中毕业证书",
        subtitle: "语言与文化职业方向",
        desc: "专注于分析、通识 culture and 语言掌握的卓越培训。",
        campuses: "埃夫龙, 圣巴泽耶 & 圣蒂勒校区",
        ...
        univ_jobs: ["外交武官", "专业翻译员", "编辑经理", "国际关系官员"]
      },
      bac_vente: {
        title: "专业销售高中毕业证书",
        subtitle: "销售与商业职业方向",
        desc: "旨在培养全渠道环境下的客户关系专家。",
        campuses: "埃夫龙, 圣巴泽耶 & 圣蒂勒校区",
        duration: "3年（非法语母语学生为4年）",
        level: "4级（专业文凭）",
        prog_title: "职业化培养",
        ...
        bts_jobs: ["资深销售员", "部门经理", "外勤销售代理", "大客户执行"],
        univ_list: ["商业与营销本科", "电子商务专业本科", "国际贸易学位"],
        univ_jobs: ["销售区域经理", "初级大客户经理", "配送经理", "商店副总监"]
      },
      bac_stmg: {
        title: "管理技术高中毕业证书",
        subtitle: "管理与商务职业方向",
        ...
        bts_desc: "技术 BTS 计划提供会计或 management 方面的即时专业化。",
        ...
        univ_jobs: ["初级管理控制员", "人力资源项目经理", "财务分析师", "团队经理"]
      }
    },
    football_pages: {
      prog_title: "精英足球计划",
