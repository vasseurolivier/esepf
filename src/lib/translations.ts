export const translations = {
  fr: {
    ...
    competition_page: {
      ...
      p3: "Les entraîneurs et les encadrants suivent de près la préparation des joueurs, en adaptant le programme d’entraînement aux exigences des matchs. L’objectif est de permettre à chaque joueur de s’exprimer pleinement sur le terrain, de développer son potentiel and de construire un parcours ambiieux, tout en bénéficiant d’un accompagnement scolaire adapté.",
    ...
    team_page: {
      ...
      staff_desc: "Une équipe de professeurs agrégés ou certifiés et de coachs certifiés UEFA pour un encadrement d'exception.",
  ...
  en: {
    ...
    team_page: {
      ...
      staff_desc: "A team of agrégé or certified professors and UEFA certified coaches.",
  ...
  zh: {
    ...
    team_page: {
      ...
      team_title: "团队介绍",
      staff_title: "我们的教职员工",
      staff_desc: "由高级教师或认证教师与欧足联认证教练组成的团队，提供卓越的指导。",
    ...
    college_page: {
      title: "ESEPE - 初中部",
      age_label: "11 - 15 岁",
      p1: "我们为11至14岁的学生开启体育学习初中部的大门。",
      p2: "在完成四年初中课程后，他们可以进入我们的高中计划。",
      p3: "该初中部丰富了我们的培训体系，支持年轻人追求卓越。",
      prog_title: "我们的课程涵盖四年：",
      year1_title: "第一年：整合班 或 六年级",
      year1_desc: "该计划将使他们获得扎实的法语掌握能力（外国学生为FLE），同时学习学术基础。",
      year2_title: "第二年：七年级",
      year2_desc: "巩固学术基础、加强自主性并深化密集体育实践的一年。",
      year3_title: "第三年：八年级适配课程",
      year3_desc: "深化技战术能力并全面融入机构生活的关键一年。",
      year4_title: "第四年：九年级准备初中毕业考",
      year4_desc: "密集准备初中毕业考试 (DNB)，并为升入高中提供个性化指导。",
      conclusion: "学生随后将直接升入我们的高中部。",
      autonomy_title: "自主性",
