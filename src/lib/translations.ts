  ...
  zh: {
    ...
    lycee_page: {
      ...
      bac_stmg: {
        ...
        desc: "STMG 技术高中是一个培养学生进入管理、行政 和 经济领域的方向. 它基于共同核心课程 和 专业选择。",
    ...
    football_pages: {
      ...
      french_method_p4: "我们s目标是培养全面的球员：他们不仅在技术和体能上表现出色，还具备在集体环境中发展所需的优秀品质. 通过培养对足球真实且持久的热爱，该计划不仅让他们在球场上进步，更为他们的体育和个人未来奠定坚实的基础。",
      pro_training: {
        title: "像职业球员一样训练",
