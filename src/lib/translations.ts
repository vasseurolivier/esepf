...
export const translations = {
  fr: {
    ...
    recognition_page: {
      ...
      diploma_text_1: "Nous préparons nos élèves aux diplômes nationaux français. Ces diplômes, tels que le diplôme national du brevet (DNB) et les baccalauréats général et technologique, sont reconnus pour leur exigence académique.",
  ...
  en: {
    ...
    recognition_page: {
      ...
      hero_title: "ESEPF",
      hero_subtitle: "A school recognized by the French Ministry of National Education",
      hero_text: "Our establishment benefits from official recognition from the French Ministry of National Education. This recognition guarantees that our school respects the educational standards and academic requirements set by the French government.",
      diploma_title: "French National Diploma",
      diploma_text_1: "We prepare our students for French national diplomas. These diplomas, such as the Diplôme National du Brevet (DNB) and the general and technological baccalaureates, are recognized for their academic requirements.",
      diploma_text_2: "In addition, they benefit from recognition by the Chinese Ministry of Education, thus offering our students a quality certification recognized in France and China.",
