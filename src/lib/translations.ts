  ...
  zh: {
    ...
    lycee_page: {
      ...
      bac_vente: {
        ...
        subtitle: "销售和商业方向",
        title_detail: "为卓越服务！",
        desc: "销售和商业专业高中，专注于奢侈品领域，将商业专业知识与奢侈品市场的要求相结合. 该课程提供销售技术、客户关系管理和商业战略方面的全面培训。",
        ...
        univ_desc: "本科是 3 年制大学培训. 它有助于加强获得的技能和承诺快速进入职业世界。",
      ...
      bac_stmg: {
        ...
        duration: "3年（非法语母语4年）",
        level: "4级",
        bts_desc: "管理 BTS 是两年的培训. 在团队 management、财务和营销等领域提供教学。",
        univ_desc: "本科 is a 3-year university course combining theory and practice. 它加强了管理和分析技能。",
    ...
    campus_pages: {
      ...
      tulle_hero: "圣蒂勒校区",
      tulle_sub: "普罗旺斯的卓越。",
      tulle_title: "上普罗旺斯阿尔卑斯省的魅力与阳光",
      tulle_desc: "我们位于普罗旺斯中心地带的圣蒂勒 (04) 校区为您的大型研讨会和培训开启大门。\n我们为您提供配备空调且光线充足的培训室、多功能运动场以及有利于社交的休闲空间。\n校内提供住宿和餐饮服务，确保您享受完全沉浸且无后顾之忧的体验。",
      tulle_sport: "体育之城",
