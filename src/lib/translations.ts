...
export const translations = {
  fr: {
    ...
    campus_pages: {
      ...
      tulle_desc: "Aux portes du Luberon, Sainte-Tulle est une cité au patrimoine riche, baignée par le soleil de la Provence. Ville à taille humaine, elle offre un cadre naturel exceptionnel propice au ressourcement.",
  ...
  en: {
    ...
    campus_pages: {
      ...
      tulle_desc: "At the gates of the Luberon, Sainte-Tulle is a city with a rich heritage, bathed in the Provence sun. A human-sized city, it offers an exceptional natural setting conducive to rejuvenation.",
  ...
  zh: {
    ...
    campus_pages: {
      ...
      tulle_desc: "圣蒂勒位于吕贝隆门口，是一座遗产丰富的城市，沐浴在普罗旺斯的阳光下。这座人性化的城市提供了一个卓越的自然环境，有利于身心康复。",
      tulle_sport: "体育之城",
