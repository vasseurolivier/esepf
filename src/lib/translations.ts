...
export const translations = {
  fr: {
    ...
    registration: {
      ...
      section_student: "INFORMATIONS PERSONNELLES (个人信息)",
      section_parent: "RESPONSABLE LÉGAL (家长/监护人)",
      section_parent1: "PARENT / TUTEUR 1 (家长/监护人 1)",
      section_parent2: "PARENT / TUTEUR 2 (家长/监护人 2)",
      section_choices: "PROJET PÉDAGOGIQUE (学习计划)",
      first_name: "Prénom (名)",
      last_name: "Nom (姓)",
      gender: "Sexe (性别)",
      boy: "Garçon (男孩)",
      girl: "Fille (女孩)",
      birth_date: "Date de naissance (出生日期)",
      nationality: "Nationalité (国籍)",
      languages_spoken: "Langues parlées (语言)",
      chinese: "Chinois (中文)",
      english: "Anglais (英语)",
      french: "Français (法语)",
      japanese: "Japonais (日语)",
      other_lang: "Autre (其它)",
      address: "Adresse (地址)",
      place_of_birth: "Lieu de naissance (出生地)",
      enrollment_date: "入学日期 (Date d'entrée souhaitée)",
      sep_2026: "Septembre 2026 (2026年9月)",
      feb_2027: "Février 2027 (2027年2月)",
      sep_2027: "Septembre 2027 (2027年9月)",
      name: "Nom complet (姓名)",
      wechat: "WeChat (微信)",
      email: "Adresse email (电子邮件)",
      phone: "Téléphone (手机)",
      campus_choice: "Campus souhaité (意向校区)",
      program_of_study: "Programme d'études (学习计划)",
      middle_school: "Collège (初中)",
      high_school: "Lycée (高中)",
      football_program: "Programme Football (足球计划)",
      code_ref: "Code ref. (Optionnel) (推荐代码)",
      submit: "ENVOYER MON DOSSIER (提交申请)",
    ...
    legal: {
      ...
      editor_content: "ESEPF - École des Sports et du Prestige Français\nAssociation loi 1901 / Organisme de formation\nDirecteur de la publication : Direction Générale ESEPF\nEmail : contact@esepf.fr",
      ...
      privacy_collect: "Dans le cadre de votre demande d'inscription ou de contact, l'ESEPF collecte des données à caractère personnel vous concernant. Ces données sont traitées uniquement pour la gestion de votre dossier pédagogique et sportif.",
      ...
      privacy_share: "L'ESEPF s'engage à ne jamais vendre ni louer vos données à des tiers. Elles ne sont transmises qu'aux services internes administratifs et pédagogiques de l'ESEPF.",
  ...
  en: {
    ...
    registration: {
      ...
      section_student: "PERSONAL INFORMATION (个人信息)",
      section_parent: "PARENT/GUARDIAN (家长/监护人)",
      section_parent1: "PARENT / GUARDIAN 1 (家长/监护人 1)",
      section_parent2: "PARENT / GUARDIAN 2 (家长/监护人 2)",
      section_choices: "PROGRAM SELECTED (学习计划)",
      ...
      languages_spoken: "Languages spoken (语言)",
      chinese: "Chinese (中文)",
      english: "English (英语)",
      french: "French (法语)",
      ...
      enrollment_date: "Enrollment date (入学日期)",
      sep_2026: "September 2026 (2026年9月)",
      feb_2027: "February 2027 (2027年2月)",
      sep_2027: "September 2027 (2027年9月)",
      name: "Full Name (姓名)",
      wechat: "WeChat (微信)",
      email: "Email Address (电子邮件)",
      phone: "Phone Number (手机)",
      campus_choice: "Desired Campus (意向校区)",
      program_of_study: "Program of Study (学习计划)",
      middle_school: "Middle school (初中)",
      high_school: "High school (高中)",
      football_program: "Football program (足球计划)",
      code_ref: "Code ref. (Optional) (推荐代码)",
      submit: "SUBMIT APPLICATION (提交申请)",
    ...
    college_page: {
      ...
      year4_title: "Year 4: 9th grade preparing for High School",
    ...
    legal: {
      ...
      editor_content: "ESEPF - École des Sports et du Prestige Français\nAssociation loi 1901 / Organisme de formation\nPublication Director: ESEPF General Management\nEmail: contact@esepf.fr",
      hosting_content: "Google Cloud Platform (Firebase App Hosting)\nGoogle Ireland Limited\nGordon House, Barrow Street, Dublin 4, Ireland",
      ...
      privacy_collect: "As part of your registration or contact request, ESEPF collects personal data concerning you. This data is processed only for the management of your pedagogical and sporting file.",
      ...
      privacy_share: "ESEPF undertakes never to sell or rent your data to third parties. They are only transmitted to ESEPF's internal administrative and pedagogical services.",
  ...
  zh: {
    ...
    campus_locations: {
      ...
      bazeille_region: "圣巴泽耶 洛特-加龙省 (47)",
      bazeille_sub: "新阿基坦大区, 法国",
      tulle: "普罗旺斯 (AIX-EN-PROVENCE)",
      tulle_region: "圣蒂勒 上普罗旺斯阿尔卑斯省 (04)",
    ...
    lycee_page: {
      ...
      intro_p3: "普通高中培养分析能力与通识文化，STMG 高中为管理、商业与 economic 经济研究做准备。",
      ...
      bac_gen: {
        ...
        qualities_list: [
          "Passion for languages and culture étrangère.",
          "Aisance rédactionnelle et orale.",
          "Curiosité et ouverture d'esprit pour les cultures internationales.",
          "Volonté de perfectionner ses compétences linguistiques et d'explorer des horizons variés.",
          "Capacité à travailler de manière autonome et à effectuer des recherches approfondies."
      ...
      bac_stmg: {
        ...
        desc: "STMG 技术高中是一个培养学生进入管理、行政与经济领域的方向. It 基于共同核心课程与专业选择。",
    ...
    support_page: {
      title: "身心支持",
      desc: "专业团队保证最佳条件. 得益’于我们的教练、体能训练师和运动健康专家的专业知识，我们提供高质量的监督，同时促进每位学生的表现和福祉。",
      team_title: "我们的团队",
      kine: "物理治疗师",
      mental: "心理教练",
      medecin: "医生",
    ...
    legal: {
      ...
      property_content: "本网站及其所有内容（文字、图片、视频、标志）均为 ESEPF 的专有财产. 未经事先书面许可，严禁任何形式 de 复制、修改 or 传播。\n本站所引用的合作俱乐部标志其版权归各自所有者所有。",
