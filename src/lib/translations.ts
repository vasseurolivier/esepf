...
export const translations = {
  fr: {
    ...
    college_page: {
      ...
      year2_title: "Année 2 : Classe de 5e adaptée",
      ...
      year3_title: "Année 3 : Classe de 4e adaptée",
      ...
      year4_title: "Année 4 : Classe de 3e préparant au Brevet",
  ...
  en: {
    ...
    college_page: {
      ...
      year2_title: "Year 2: 7th grade adapted",
      year2_desc: "A year to consolidate cycle 4 achievements, reinforce autonomy and deepen intensive sports practice.",
  ...
  zh: {
    ...
    college_page: {
      ...
      year2_title: "第二年：七年级适配课程",
      year2_desc: "巩固第四阶段学习成果的一年，加强自主性并深化密集体育练习。",
