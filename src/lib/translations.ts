...
export const translations = {
  fr: {
    ...
    registration: {
      ...
      grade_placeholder: "Ex: 4ème, Seconde...",
      ...
      programs: {
        college: "Collège",
        bac_gen: "Bac Général",
        bac_stmg: "Bac Techno STMG",
        integration: "Classe d'Intégration (FLE)"
      }
    },
    registration_steps: {
    ...
    recognition_page: {
      ...
      guarantees: [
        ...
        { title: "Chinoise Validation", desc: "Double reconnaissance pour une mobilité internationale facilitée." },
  ...
  en: {
    ...
    registration: {
      ...
      grade: "Current Grade",
      grade_placeholder: "Ex: 8th grade, Seconde...",
      email: "Contact Email",
      phone: "Phone Number",
      ...
      programs: {
        ...
        bac_gen: "General Baccalaureate",
        bac_stmg: "Techno STMG Baccalaureate",
        integration: "Integration Class (FLE)"
      }
    },
    registration_steps: {
  ...
  zh: {
    ...
    formations: {
      ...
      fle_desc: "为非法语母语学生打造的卓越路径，旨在帮助他们掌握莫里哀s语言并平稳融入法国教育体系。",
      ...
      pedagogy_p2: "我们的学生不只是学习 grammar 规则；他们通过项目、辩论和与当地 cultures 的持续互动来体验语言。",
    ...
    team_page: {
      ...
      team_title: "团队介绍",
      staff_title: "我们的教职员工",
      staff_desc: "由高级教师 和 欧足联认证教练组成的团队， offer 卓越s指导。",
    ...
    lycee_page: {
      ...
      bac_stmg: {
        ...
        luxe_module_p1: "In 奢侈品行业不断扩张的世界中，让我们的学生做好准备至关origin。",
    ...
    football_pages: {
      ...
      reconnaissance_p1: "法国的人才辈出源于其完善s选拔 和 培养体系。",
      ...
      axes_phys: "体能",
      axes_phys_desc: "运动机能的开发以科学严谨的方式进行。通过针对不同年龄段量身定制的体能训练计划，我们打造出力量强、速度快、耐力持久的运动员。预防伤病、爆发力以及恢复的优化是我们监测的核心，以确保在最高水平上实现可持续s竞技表现。",
      axes_ment: "心理",
      ...
      axes_social_school_desc: "一不能想象一个没有教育s学院。足球是一项需要智慧s运动，这就是为什么学业教育项目是强制性s，球员必须参与才能留在学院。",
      ...
      axes_social_psych_desc: "高水平运动需要强大s意志力，因此我们为球员提供所有必要s支持，帮助他们全面发展。这让他们能够自由表达，预防任何心理不适或其他问题。",
