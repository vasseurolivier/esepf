...
export const translations = {
  fr: {
    ...
    campus_pages: {
      ...
      evron_sub: "Le cœur historique et administratif de l'ESEPF en Sarthe (LE MANS).",
  ...
  zh: {
    ...
    lycee_page: {
      ...
      bac_gen: {
        ...
        duration: "3年（非法语母语4年）",
        level: "4级 (高中毕业)",
        bts_desc: "应用外语 (LEA) 的 BTS 是一个为期两年的培训。它在翻译、口译、国际项目 management 等领域提供教学。通过档案申请，BTS 可以快速为职业生涯做好准备。",
      ...
      bac_stmg: {
        ...
        outro: "它打开了通往高等教育的大门，如 BTS、BUT、本科或商学院，并引导学生进入管理、营销、人力资源或财务领域的职业生涯。",
