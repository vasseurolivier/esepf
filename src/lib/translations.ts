...
export const translations = {
  fr: {
    ...
    football_pages: {
      ...
      reconnaissance_p1: "La France et ses environs ne manquent certainement pas de talents, et cela n'est en rien dû au hasard, but bien à la manière dont les jeunes joueurs sont détectés et formés dans le pays. This method, whose effectiveness is recognized worldwide, is at the heart of French football success.",
