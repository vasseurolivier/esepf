...
export const translations = {
  fr: {
    ...
    football_pages: {
      ...
      axes_tech: "Technique",
      axes_tech_desc: "Travail spécifique sur la maîtrise individuelle du ballon, la coordination et la justesse technique sous pression.",
      axes_tact: "Tactique",
      axes_tact_desc: "Appréhension des systèmes de jeu, intelligence collective, placement et compréhension des transitions offensives/défensives.",
      axes_phys: "Physique",
      axes_phys_desc: "Développement athlétique sécurisé, endurance, force et explosivité adaptée à la morphologie et à l'âge du joueur.",
      axes_ment: "Mental",
  ...
  en: {
    ...
    football_pages: {
      ...
      axes_tech: "Technical",
      axes_tech_desc: "Specific work on ball control, coordination and technical accuracy under pressure.",
      axes_tact: "Tactics",
      axes_tact_desc: "Understanding of game systems, collective intelligence, positioning and transition management.",
      axes_phys: "Physical",
      axes_phys_desc: "Safe athletic development, endurance, strength and explosiveness adapted to the player's age.",
      axes_ment: "Mental",
  ...
  zh: {
    ...
    football_pages: {
      ...
      method_subtitle: "LES 5 AXES DE RÉUSSITE",
      axes_tech: "技术",
      axes_tech_desc: "针对控球、协调能力及高压环境下技术精准度的专项训练。",
      axes_tact: "战术",
      axes_tact_desc: "对比赛系统的理解、集体智慧、选位以及对攻防转换的掌握。",
      axes_phys: "体能",
      axes_phys_desc: "安全的运动机能开发、耐力、力量及适应球员年龄与形态的爆发力训练。",
      axes_ment: "心理",
      axes_ment_desc: "我们的训练方法不断挑战球员的极限，迫使他们调动心理资源。性格力量是影响表现的要素之一，我们设计了许多练习让球员锻炼这种特质（1对1、人数劣势比赛、高强度体能训练、肌肉强化、高标准要求等）。鉴于职业足球需要强大的心理素质，球员从小培养这种素质至关重要。",
      axes_social: "社会",
