...
export const translations = {
  ...
  zh: {
    ...
    formations: {
      ...
      why_choose_desc: "这是进入美国大学或欧洲国际课程的重要资产。学生在高等学术水平上培养自主性 and 英语掌握能力。",
      modalities_title: "形式",
      modalities_list: [
        "与美国教师进行视频会议课程",
        "由 ESEPF 专属导师跟踪",
      ...
      passport_world_desc: "在全 globalization 的世界中，掌握多种语言是必要的。在 ESEPF，我们从初中开始提供强化的语言路径。",
      efl_title: "英语第一语言 (EFL)",
      efl_desc: "为希望达到双语水平的学生提供强化计划，包括英语文学 and 历史课程。",
      cert_int_title: "国际认证",
      cert_int_desc: "准备剑桥考试（PET、FCE、CAE）and DELF，以官方验证所获技能。"
    },
    outlets_labels: {
    ...
    competition_page: {
      ...
      official_subtitle: "特权访问地区 and 国家精英",
    ...
    history_page: {
      ...
      intro_p1: "ESEPF 根植于我们在中国 and 越南的成功体育学院。",
      intro_p2: "ESEPF 位于法国中心，源于这一愿景。",
      intro_p3: "为每位学生提供卓越的钥匙，同时建立稳固的学术 and 职业未来。",
      mission_label: "我们的使命：",
      quote: "我们通过卓越教育在不同文化 and 大陆之间架起桥梁。",
    ...
    team_page: {
      ...
      p3: "这一独特的计划不仅塑造运动员也塑造学生，灌输纪律、严谨 and 雄心。",
      team_title: "团队介绍",
      staff_title: "我们的教职员工",
      staff_desc: "由高级教师 and 欧足联认证教练组成的团队，提供卓越的指导。",
      success_rate: "100% 考试成功率",
      uefa_cert: "员工认证",
      discipline_title: "纪律",
      discipline_desc: "球场 and 课堂上追求卓越的关键。",
      solidarity_title: "团结",
      solidarity_desc: "超越国界的团队精神。",
      ambition_title: "雄心",
      ambition_desc: "瞄准全球学术 and 体育巅峰。",
      innovation_title: "创新",
    ...
    college_page: {
      ...
      year2_desc: "深化学术 and 体育技能的关键一年，同时充分融入机构生活。",
    ...
    lycee_page: {
      ...
      bac_gen: {
        ...
        profile_list: ["初中毕业生进入高一", "高一 or 高二学生进入高二"],
      ...
      bac_vente: {
        ...
        higher_ed_intro: "获得证书后，您可以继续攻读 BTS or 大学本科。",
    ...
    football_pages: {
      ...
      coaches_text: "教练均毕业于 FFF or UEFA，提供高水平指导。",
      weekly_title: "每周计划",
    ...
    campus_pages: {
      ...
      tulle_infra_desc: "圣蒂勒校区注重人性化 and 个性化的教学方法。",
      infra_title: "卓越的基础设施",
      city_title: "生活环境",
