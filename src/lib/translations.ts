...
export const translations = {
  fr: {
    ...
    campus_pages: {
      ...
      bazeille_desc: "Notre site de Sainte-Bazeille (47) vous accueille dans un cadre calme et verdoyant au cœur du Lot-et-Garonne. Idéal pour vos formations, il dispose de salles modulables entièrement équipées, d'un terrain de sport pour les activités de groupe, et d'un espace de détente chaleureux.\nL'hébergement sur place et la restauration vous garantissent un séjour tout compris et serein.",
      bazeille_culture: "Culture & Terroir",
      bazeille_culture_desc: "Sainte-Bazeille est réputée pour sa convivialité et ses infrastructures sportives de premier plan, parfaitement intégrées à la vie locale.",
      bazeille_infra_desc: "Le Campus de Sainte-Bazeille se distingue par son architecture moderne et ses espaces de co-working.",
