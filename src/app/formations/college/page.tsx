...
export default function CollegePage() {
  ...
  const collegeYears = [
    { id: '01', title: t.college_page.year1_title, desc: t.college_page.year1_desc },
    { id: '02', title: t.college_page.year2_title, desc: t.college_page.year2_desc },
    { id: '03', title: t.college_page.year3_title, desc: t.college_page.year3_desc },
    { id: '04', title: t.college_page.year4_title, desc: t.college_page.year4_desc },
  ];
            ...
            <div className="bg-primary text-white p-12 lg:p-20 rounded-[4rem] shadow-2xl mt-24 relative overflow-hidden">
              ...
              <div className="space-y-16 relative z-10">
                {collegeYears.map((year) => (
                  <div key={year.id} className="flex flex-col md:flex-row gap-8 md:gap-16 group">
                    <div className="text-5xl font-headline font-bold text-secondary opacity-40 group-hover:opacity-100 transition-opacity shrink-0">{year.id}</div>
