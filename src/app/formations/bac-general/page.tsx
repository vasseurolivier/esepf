...
import { GraduationCap, BookOpen, Globe, Award, MessageSquare } from 'lucide-react';
    ...
    <FirebaseClientProvider>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] flex items-center justify-center bg-[#0a192f] overflow-hidden">
          <Image 
            src="https://picsum.photos/seed/bac-gen/1920/1080"
            alt="Bac Général"
            fill
            className="object-cover opacity-40"
            data-ai-hint="library building architecture"
            priority
          />
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <ScrollReveal delay={200} className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border-8 border-muted/20">
                <Image 
                  src="https://picsum.photos/seed/study-1/800/600"
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Program */}
              <ScrollReveal className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-border/50">
              ...
              {/* Outlets */}
              <ScrollReveal delay={100} className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-border/50">
              ...
              {/* Jobs */}
              <ScrollReveal delay={200} className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-border/50">
