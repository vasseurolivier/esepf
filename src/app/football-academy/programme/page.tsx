        ...
        <div className="relative z-10 text-center text-white container px-4">
          <ScrollReveal>
            ...
            <div className="flex wrap justify-center gap-4">
              <button onClick={() => scrollToSection('fr-section')} className="bg-black/50 backdrop-blur-md text-white border border-white/20 px-8 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-secondary transition-colors shadow-xl">{t.football_pages.football_fr_btn}</button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center max-w-6xl mx-auto">
            <ScrollReveal className="space-y-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 font-bold uppercase tracking-widest text-xs text-primary"><CheckCircle2 className="text-secondary" /> {t.football_pages.coaches_list_1}</div>
                <div className="flex items-center gap-3 font-bold uppercase tracking-widest text-xs text-primary"><CheckCircle2 className="text-secondary" /> {t.football_pages.coaches_list_2}</div>
                <div className="flex items-center gap-3 font-bold uppercase tracking-widest text-xs text-primary"><CheckCircle2 className="text-secondary" /> {t.football_pages.coaches_list_3}</div>
              </div>
            </ScrollReveal>
